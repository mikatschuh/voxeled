        ...
        for y in 0..32 {
            for z in 0..32 {
                ...
                if faces[1][y][z] & (FIRST_BIT >> x) != 0 {
                    mesh.add_px(position, data[x][y][z].texture(), chunk.lod)
                }
                if faces[2][z][x] & (FIRST_BIT >> y) != 0 {
                    mesh.add_ny(position, data[x][y][z].texture(), chunk.lod)
                }
                if faces[3][z][x] & (FIRST_BIT >> y) != 0 {
                    mesh.add_py(position, data[x][y][z].texture(), chunk.lod)
                }
                if faces[4][x][y] & (FIRST_BIT >> z) != 0 {
                    mesh.add_nz(position, data[x][y][z].texture(), chunk.lod)
                }
                if faces[5][x][y] & (FIRST_BIT >> z) != 0 {
                    mesh.add_pz(position, data[x][y][z].texture(), chunk.lod)
                }
            }
        }
    }
